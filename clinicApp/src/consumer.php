...
// Check connection
    ...
    // foreach ($messages as $messageBody) {
       ...
       $sql = "INSERT INTO appointmentstatusclinic (appointmentid,patient_ic,patient_name,dr_name,patient_phone,appointment_date,appointment_time,status)
    VALUES ('$appointmentid','$patient_ic','$patient_name','$dr_name','$patient_phone','$appointment_date','$appointment_time','$status')";
